...
import { OfflineOrdersTable } from '@/components/features/OfflineOrdersTable';
import { OrderItem } from '@/types';
import { Shirt, Package, Baby } from 'lucide-react';

// Generate mock orders data for Offline Orders
const generateMockOrders = (): OrderItem[] => {
  const baseOrders: Omit<OrderItem, 'productIcon'>[] = [
    ...
    {
      id: '200047',
      product: 'Rare Rabbit White Shirt',
      category: 'Mens',
      quantity: 'XL - 2',
      price: '₹ 1456',
      orderCreatedTime: '10:35 Am, 17Dec 26',
  ...
  const ordersWithIcons: OrderItem[] = [
    ...
    { ...baseOrders[5], productIcon: iconMap.gray },
...
export default function OfflineOrdersPage() {
  ...
  return (
    <main className="space-y-6" role="main" aria-label="Offline Orders">
      <OfflineOrdersTable orders={orders} />
