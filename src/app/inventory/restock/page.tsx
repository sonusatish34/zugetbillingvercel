...
import { ReStockItemsTable } from '@/components/features/ReStockItemsTable';
...
export default function RestockItemPage() {
  ...
  return (
    <main className="space-y-6" role="main" aria-label="Re Stock Items">
      <ReStockItemsTable items={items} />
